  ...
  return (
    <Fragment>
      ...
      <Head>
        ...
        <meta name="description" content="Trusted AROGYA SuperSpecialty in Location. Discover our expert surgeries, treatments, and compassionate healthcare." />
        <link rel="canonical" href="https://arogyamastu.com" />
      </Head>
      ...
      <main className="content-wrapper overflow-hidden">
        ...
        <section className="wrapper bg-light">
          <div className="container pt-8 pt-md-15">
            <About
              imgPosition="right"
              imgSrc="/img/arogya.webp"
              heading="Best AROGYA Super Specialty Hospital in Location"
          ...
          <div className="container">
            <div className="col-md-10 col-lg-8">
              ...
              <h2 className="display-5 mb-16 fw-bold z-1 mt-n15 mt-md-n16 mt-lg-n17 sub-head">
                AROGYA Super Specialty Hospital in Location
                <span
